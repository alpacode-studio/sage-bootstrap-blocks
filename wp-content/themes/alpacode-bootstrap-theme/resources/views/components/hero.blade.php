...
<section class="hero__v6 section" id="home">
  <div class="container">
    <div class="row">
          ...
          <div class="col-lg-11"><span class="hero-subtitle text-uppercase" data-aos="fade-up" data-aos-delay="0">Innovative Fintech Solutions</span>
            ...
            <div class="logos mb-4" data-aos="fade-up" data-aos-delay="400"><span class="logos-title text-uppercase mb-4 d-block">Trusted by major companies worldwide</span>
              <div class="logos-images d-flex gap-4 align-items-center">
                <img class="img-fluid js-img-to-inline-svg" src="{{ get_template_directory_uri() }}/resources/images/logo/actual-size/logo-air-bnb__black.svg" alt="Company 1" style="width: 110px;">
                <img class="img-fluid js-img-to-inline-svg" src="{{ get_template_directory_uri() }}/resources/images/logo/actual-size/logo-ibm__black.svg" alt="Company 2" style="width: 80px;">
                <img class="img-fluid js-img-to-inline-svg" src="{{ get_template_directory_uri() }}/resources/images/logo/actual-size/logo-google__black.svg" alt="Company 3" style="width: 110px;">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-6">
        <div class="hero-img">
          <img class="img-card img-fluid" src="{{ get_template_directory_uri() }}/resources/images/card-expenses.png" alt="Image card" data-aos="fade-down" data-aos-delay="600">
          <img class="img-main img-fluid rounded-4" src="{{ get_template_directory_uri() }}/resources/images/hero-img-1-min.jpg"