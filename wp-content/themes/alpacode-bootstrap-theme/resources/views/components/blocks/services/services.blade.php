    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 {{ $reverseIntro ? 'order-2' : 'order-1' }}">
        <div class="intro-content" data-aos="{{ $reverseIntro ? 'fade-left' : 'fade-right' }}" data-aos-delay="100">
          ...
          @if(isset($intro['badge']) && $intro['badge'])
          ...
          @if(isset($intro['ctaText']) && $intro['ctaText'])
...
.services .cta-button:hover {
  background: color-mix(in srgb, var(--accent-color, #007bff), #000 10%);
...
.services .service-card .card-number {
  background: linear-gradient(135deg, var(--accent-color, #007bff), color-mix(in srgb, var(--accent-color, #007bff), #000 20%));
  width: 60px;
  height: 60px;
  border-radius: 50%;
  display: flex;
...
.services .service-card .card-number span {
  color: var(--contrast-color, #fff);
  font-size: 18px;
  font-weight: 700;
}
...
.service-details .service-content .service-header .service-intro {
  font-size: 18px;
  line-height: 1.7;
  color: color-mix(in srgb, var(--default-color, #6c757d), transparent 20%);
}
...
.service-details .service-features .feature-item {
  ...
  background: var(--surface-color, #fff);
  border-radius: 8px;
  border: 1px solid color-mix(in srgb, var(--default-color, #6c757d), transparent 90%);
  transition: all 0.3s ease;
}

.service-details .service-features .feature-item:hover {
  box-shadow: 0 8px 25px color-mix(in srgb, var(--default-color, #6c757d), transparent 90%);
  transform: translateY(-2px);
}

.service-details .service-features .feature-item .feature-icon {
  background: color-mix(in srgb, var(--accent-color, #007bff), transparent 90%);
  width: 60px;
  height: 60px;
  border-radius: 50%;
  display: flex;
...
.service-details .service-features .feature-item .feature-content p {
  font-size: 14px;
  margin: 0;
  color: color-mix(in srgb, var(--default-color, #6c757d), transparent 30%);
}
...
.service-details .service-process .process-steps .process-step:not(:last-child)::after {
  ...
  width: 2px;
  height: 40px;
  background: color-mix(in srgb, var(--accent-color, #007bff), transparent 70%);
}
...
.service-details .service-sidebar .service-menu .menu-list .menu-item {
  ...
  align-items: center;
  padding: 15px 0;
  border-bottom: 1px solid color-mix(in srgb, var(--default-color, #6c757d), transparent 90%);
  color: var(--default-color, #6c757d);
  text-decoration: none;
  transition: all 0.3s ease;
}
...
.service-details .service-sidebar .service-menu .menu-list .menu-item i {
  margin-right: 12px;
  font-size: 16px;
  color: color-mix(in srgb, var(--default-color, #6c757d), transparent 40%);
  transition: color 0.3s ease;
}
...
.service-details .service-sidebar .contact-card .contact-content .btn:hover {
  background: color-mix(in srgb, var(--contrast-color, #fff), transparent 10%);
  transform: translateY(-2px);
}
