...
<x-hero.features :reverseIntro="true" />
...
{{-- No stats --}}
<x-hero.features :showStats="false" />
...
<x-hero.features :gridColumns="2" />

{{-- 4-column grid layout --}}
<x-hero.features :gridColumns="4" />
...
{{-- Custom feature icon --}}
<x-hero.features-tabs featureIcon="bi bi-check2-circle" />
