...
function initMobileNavigation() {
  ...
  // Initialize when navigation component mounts
  initMobileNavigation();
</script>

<script>
  /**
 * Navigation scrollspy functionality
 * Use with: Navigation component to highlight active menu items
 */
function initNavigationScrollspy(navSelector = '.navmenu a') {
  let navmenulinks = document.querySelectorAll(navSelector);
  ...
  function navmenuScrollspy() {
    navmenulinks.forEach(navmenulink => {
      ...
      if (position >= section.offsetTop && position <= (section.offsetTop + section.offsetHeight)) {
        ...
        document.querySelectorAll(`${navSelector}.active`).forEach(link => 
...
// Initialize when navigation component mounts
initNavigationScrollspy('.navmenu a');
</script>