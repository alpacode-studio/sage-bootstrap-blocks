    ...
    trigger.addEventListener('click', function(e) {
      ...
      if (toggle) {
        if (faqItem.classList.contains('faq-active')) {
          toggle.className = toggle.className.replace('bi-plus', 'bi-dash');
        } else {
          toggle.className = toggle.className.replace('bi-dash', 'bi-plus');
        }
      }
    });
  });
